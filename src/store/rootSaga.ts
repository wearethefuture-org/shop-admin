...
import {addUserWorker, deleteUserWorker, getUsersWorker, updateUserWorker} from "./sagas/users.saga";
...
export default function* rootSaga(): SagaIterator {
    yield all([fork(sagaCategoriesWatcher), fork(sagaProductsWatcher), fork(sagaSettingsWatcher), fork(sagaSlidesWatcher), fork(sagaUsersWatcher), fork(sagaUserWatcher)]);
}
