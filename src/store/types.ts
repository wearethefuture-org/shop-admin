...
export const GET_USERS_BY_QUERY_REQUEST = 'GET_USER_BY_QUERY_REQUEST';
export const GET_USERS_BY_QUERY_SUCCESS = 'GET_USER_BY_QUERY_SUCCESS';
export const GET_USERS_BY_QUERY_ERROR = 'GET_USER_BY_QUERY_ERROR';
