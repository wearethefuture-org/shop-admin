...
import {
  ...
  fetchUploadImagesProductWorker,
  fetchUploadPrewiesProductWorker
...
export function* sagaProductsWatcher(): SagaIterator {
  ...
  yield takeEvery(REQUEST_UPLOAD_IMAGES_PRODUCT, fetchUploadImagesProductWorker);
  yield takeEvery(REQUEST_UPLOAD_PREWIES_PRODUCT, fetchUploadPrewiesProductWorker);
}
