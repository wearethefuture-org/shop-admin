...
import {IUserReqAdd, IAuthResponse, IUserReqUp, IUserCreeds, IUserItem, IUsersData} from "../interfaces/IUsers";
...
export const api: ApiFetchedDataType = {
    ...
    slides: {
        ...
        updateVisibility: (slide) => instance.patch(`${root}/slide/visibility/${slide.id}`, {isShown: slide.isShown}),
    ...
    user: {
        auth: (user) => instance.post(`${root}/auth/login/admin`, user),
