    ...
    return (
        ...
        >
            ...
            <DialogContent dividers>
                <DialogContentText>Ви дійсно бажаєте видалити {user.firstName} {user.lastName}</DialogContentText>
            </DialogContent>
            <div>
                <Button className={classes.remove} onClick={handleClose}>Відміна</Button>
                <Button className={classes.remove} onClick={removeUser}>Видалити</Button>
